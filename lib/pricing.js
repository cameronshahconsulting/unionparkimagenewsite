...
export const INSTALLATION = {
  ...
  radiusMiles: 30,
  /** Store credit on the customer's next Annie's order after installing with Union Park. */
  nextOrderCreditPercent: 25,
  note: "Request an installation estimate — Union Park Landscaping will follow up. Enter your delivery address and we’ll confirm you’re within about 30 miles of our Wilmington shop. When you install with them, you earn 25% in-store credit toward your next Annie's Online Nursery order.",
  creditNote: "Install with Union Park and earn 25% in-store credit on your next Annie's order — not a discount on this checkout.",
};
