  ...
  if (resendConfigured()) {
    try {
      ...
      await sendEmail({
        ...
        html: `<p style="font-family:system-ui,sans-serif;font-size:16px;color:#0a3a26">Your verification code is</p>
<p style="font-family:system-ui,sans-serif;font-size:32px;font-weight:800;letter-spacing:.2em;color:#0a3a26">${code}</p>
<p style="font-family:system-ui,sans-serif;font-size:13px;color:#3d5648">Expires in 15 minutes. If you didn’t ask for a yard design, ignore this email.</p>
