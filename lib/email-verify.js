...
export async function sendVerificationCode({ email, ipHash }) {
  ...
  if (resendConfigured()) {
    try {
      ...
      await sendEmail({
        to: normalized,
        subject: "Your Union Park yard design code",
        text: [
        ...
        html: `<p style="font-family:system-ui,sans-serif;font-size:16px;color:#093544">Your verification code is</p>
<p style="font-family:system-ui,sans-serif;font-size:32px;font-weight:800;letter-spacing:.2em;color:#093544">${code}</p>
<p style="font-family:system-ui,sans-serif;font-size:13px;color:#4a6570">Expires in 15 minutes. If you didn’t ask for a yard design, ignore this email.</p>
<p style="font-family:system-ui,sans-serif;font-size:12px;color:#4d6b5c;margin-top:16px">— Union Park Landscaping</p>
${compliance.html}`,
      });
      emailed = true;
    } catch (err) {
